...
export default () => {
  ...
  return <Calculator pageTitle="Tower Calculator" valueSetter={setValues}>
    ...
    {data.mode === "silver" && <Input.Text
      ...
      after={
        <>
          <input type="radio" className="btn-check" name="toSilverUnit" id="toSilverUnit-b" autoComplete="off" value="B" defaultChecked={data.toSilverUnit === "B"} />
          <label className="btn btn-outline-secondary" htmlFor="toSilverUnit-b">B</label>
          <input type="radio" className="btn-check" name="toSilverUnit" id="toSilverUnit-m" autoComplete="off" value="M" defaultChecked={data.toSilverUnit === "M"} />
          <label className="btn btn-outline-secondary" htmlFor="toSilverUnit-m">M</label>
        </>
      } />}
    {data.mode === "ak" && <Input.Text
      key="toAK"
      id="toAK"
      label="Available AK"
